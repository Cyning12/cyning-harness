...
- 用 ≤800 字中文写「我理解的核心结论」：五 bullet（OOP 定位 / 本体定位 / HGM 定位 / 与 LangChain 差异 / **v1.0 前不做什么 HGM**）
...
| **理论** | 「OOP 升级」表述是否作为标题？HGM **v2.x** 写多少？ |
...
- 不得把 **v2.x HGM** 写成「已发布能力」；对外写 **Track G / G1 提案（v2.0+ 能力标签 · v1.0 后主版本 2 · 非主轨 v0.5）**
