...
| 检查项 | 期望 |
| --- | --- |
| ROADMAP §2 表顺序 vs 版本号 | `v0.5.x` HGM 在 **闸门** 上依赖 `v1.0` 完成，但 semver 数字易误读为「早于 v1.0」 |
| 对外表述建议 | 是否统一为 **「Track G / G1 能力 / v0.5+ 提案」** 而非单独写 `v0.5` 产品版 |
...
| 级别 | ID | 摘要 | 状态 |
| --- | --- | --- | --- |
| **P0** | SEM-01 | `v1.0` 完成后才启动 HGM，但轨道代号 `v0.5.x` 与 semver 直觉冲突 | ✅ 2026-06-15 落盘 |
