...
| **版本**  | v1.1                                               |
| **日期**  | 2026-06-15                                         |
| **路线真值** | [`ROADMAP_v1_zh.md`](./ROADMAP_v1_zh.md) · 对齐 L1 STRATEGY_MASTER |
...
| O3 | HGM `events/*.jsonl` 原型（**proposal · 未实现**） | Track G · v0.5+ |
...
| # | 项 | 版本 |
| --- | --- | --- |
| K1 | 事件 schema + ingest（**proposal · 未实现**） | Track G · G1 / v0.5+ |
| K2 | snapshot + axioms check（**proposal**） | v0.5–v0.6 |
| K3 | timeline / patterns（**proposal**） | v0.7–v0.8 |
| K4 | 与 Runtime/C 轨推理衔接 | v1.0+ · **未立项** |

> **Track G 用语**：**G1 / v0.5+** 为能力标签，**启动闸门在 v1.0 之后**（见 [`ROADMAP_v1_zh.md`](./ROADMAP_v1_zh.md) §2.2 · §5）· 非「下一个产品 semver」。

### 5.4 试点与叙事轨（B/D · 摘要）

| 轨 | 项 | 指针 |
| --- | --- | --- |
| B | kimi-code-meta · 上游 PR · B2 量化 | [`pointers/PILOT_kimi_code_fork_v1_zh.md`](./pointers/PILOT_kimi_code_fork_v1_zh.md) |
