...
| **非范围** | 商业战略、ETCLOVG 行业对标（见工作区 `[STRATEGY_ONTOLOGY](../../../docs/harness/guides/STRATEGY_ONTOLOGY_cyning_harness_v1_zh.md)`） |
| **真值**  | 本文件 + `[ARCHITECTURE.md](./ARCHITECTURE.md)` + `[../harness/templates/](../harness/templates/)` + `[ontology.yaml](./ontology.yaml)`（机器可读抽取 · v0.4+） |
