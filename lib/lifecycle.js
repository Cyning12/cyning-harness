...
const GUARD_ADAPTERS = {
  ...
  close_graph_delta: evaluateCloseGuard('close_graph_delta'),
  close_kpi: evaluateCloseGuard('close_kpi'),
  close_experience: evaluateCloseGuard('close_experience'),
  close_wiki_delta: evaluateCloseGuard('close_wiki_delta'),
  close_wiki_promotion: evaluateCloseGuard('close_wiki_promotion'),
};
